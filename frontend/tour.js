...
export const CHAPTERS = [
  ...
  },
  {
    ...
    body: [
      ...
      h('br'),
      b('Esc'), ' is ', b('PANIC'), ', and it means everything: notes, the metronome, ',
      'the loop, a score that is playing and a backing track. It is the button for ',
      'when you do not know what is making a noise. It ', h('em', null, 'stops'),
      ' things and clears nothing — your loop keeps its layers, your tempo stays put, ',
      'and it all starts again. It fires from anywhere, even while you are typing in a ',
      'box: the one shortcut that never stands aside.',
    ],
  },
  {
    ...
    body: [
      ...
      'It goes full screen — the roll, the keyboard, and nothing else. ', b('Esc'),
      ' brings the app back.', h('br'), h('br'),
      'On its own, the notes you play rise out of the keyboard — the falling-notes ',
      'videos, upside down. A bar’s length is how long you held the note and the gap ',
      'above it is how long you waited, so legato, staccato and a chord you rolled by ',
      'accident all become things you can see. In a split or a layer each zone gets ',
      'its own colour.', h('br'), h('br'),
      'Press ', b('S'), ' for your songs. Drop a ', b('.mid'), ' on the screen and it ',
      'falls down the roll for you to play along with — silently, waiting at each ',
      'chord until you have played it.',
    ],
  },
  {
