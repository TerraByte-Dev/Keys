...
export function createSheet(ctx) {
  ...
  const el = mod('Sheet music', 'bring your own',
    h('div.note', null,
      ...
      'MuseScore, Sibelius, Dorico, Finale, Noteflight, Flat.'),
    h('div.note', { style: { marginTop: '8px' } },
      'A ', h('strong', null, '.mid'), ' works too, and is converted on the way in. ',
      'It is worth knowing what that can and cannot do: a MIDI written BY a notation ',
      'program is already quantised and already has its hands on separate tracks, so ',
